        ...
        <div class="col-sm-6 right_section">
            ...
            <form action="{{route('register')}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input name="password_confirmation" type="password" class="form-control tell"  placeholder="تکرار رمز عبور"  required>
                </div>

                <div class="buttons">
                    <button type="submit" class="btn btn-primary  login-btn">ثبت نام</button>
                    <a href="{{route('login')}}"  class="btn btn-primary  signin-btn">ورود</a>
                </div>
